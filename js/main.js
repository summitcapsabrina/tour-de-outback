...
function initWeather() {
  ...
  function buildCompass(windDir, windSpeed) {
    return '<svg class="wind-compass-svg" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">' +
      '<text class="cw-n" x="25" y="12" text-anchor="middle" font-size="9" font-weight="700" font-family="sans-serif">N</text>' +
      '<text class="cw-dir" x="25" y="46" text-anchor="middle" font-size="9" font-weight="700" font-family="sans-serif">S</text>' +
      '<text class="cw-dir" x="5" y="29" text-anchor="middle" font-size="9" font-weight="700" font-family="sans-serif">W</text>' +
      '<text class="cw-dir" x="45" y="29" text-anchor="middle" font-size="9" font-weight="700" font-family="sans-serif">E</text>' +
      '<g transform="rotate(' + windDir + ' 25 25)">' +
        '<polygon points="25,3 22,14 25,12 28,14" fill="#cc0000"/>' +
      '</g>' +
      '<text class="cw-speed" x="25" y="29" text-anchor="middle" font-size="13" font-weight="700" font-family="sans-serif">' + windSpeed + '</text>' +
    '</svg>';
  }
  ...
  function buildForecastCompass(windDirText, windSpeedStr) {
    ...
    return '<div class="forecast-compass">' +
      ...
      '</g>' +
      '<text class="cw-speed" x="25" y="29" text-anchor="middle" font-size="13" font-weight="700" font-family="sans-serif">' + speed + '</text>' +
    '</svg>' +
